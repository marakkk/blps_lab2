...
public class AppService {
    ...
    public Map<String, Object> updateAnalytics(Long appId) throws HeuristicRollbackException, SystemException, HeuristicMixedException, NotSupportedException, RollbackException {
        try {

...
class DeveloperController {
    ...
    public Map<String, Object> updateAnalytics(@PathVariable Long id) throws HeuristicRollbackException, SystemException, HeuristicMixedException, NotSupportedException, RollbackException {
